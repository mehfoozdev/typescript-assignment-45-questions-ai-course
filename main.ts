...
//Ans 2:
const personeName : string = "Mehfooz Ali"
console.log(`Hello ${personeName}, would you like to learn some TypeScript today?`)
...
//Ans 3:
const myname : string = "mehFooz aLI"
...
//Ans 6:
let myName1 : string = "\t\n Mehfooz \t\n"
console.log(myName1)            //name with tab and newline spaces
console.log(myName1.trim())       //name without spaces
...
//Ans 10:
//Mehfooz Ali -- Date: 15 April 2024
console.log(6 + 2)         //Adiition
console.log(11 - 3)        //Subtraction
console.log(4 * 2)         //Multiplication
console.log(40 / 5)        //Division
...
//Ans 11:
let names:string[] = ["Alaudin", "Wajid", "Ayan"]
...
//Ans 12:
for (let i = 0; i < names.length; i++) {
    console.log(`What are you doing '${names[i]}' lets learn TypeScript course for better future ! `)
} 
...
//Ans 13:
let fav_transport : string[] = ["Elantra", "Honda Car", "Ride 250", "Civic"]
...
//Ans 14:
let guest : string[] = ["Alaudin", "Wajid", "Ayan", "Rauf"]
guest.forEach(guest => {
    console.log(`Hey ${guest}, I would like to invite you in my birthday party.`)
})
...
//Ans 16:
let guests : string[] = ["Sumair", "faraz", "Sadiq", "Khalid"]
...
//Ans 18:
let places : string[] = ["Belgium", "Germany", "Australia", "Luxemburg", "Turkey"]
...
//Ans 19:
let guest1 : string[] = ["Atif", "Saif", "Mehmood", "Ali"]
...
//Ans 20:
let cities:string[] = ["Karachi", "Islamabad", "Peshawar", "Rahim Yar Khan", "Ghotki"]
//My try
...
console.log(`My name is ${myself.namee}, i am from ${myself.city} and i am ${myself.age} years old.`)
...
//Another Example
console.log("\n Another Example");
let secA : string[] = ["mehfooz", "wajid", "abid", "atif", "khalid"];
let secB : string[] = ["sajid", "khalid", "jamil", "wajid", "nabil"];
secB.forEach(secB => {
...
makeShirt("medium", "Learning never ends !");
...
bag("Green", "Large", "Learning never ends !");
...
//Ans 41:
let magicians:string[] = ["Akbar", "Sumair", "Hira"];
...
//Ans 43:
let magicians1:string[] = ["Akbar", "Sumair", "Hira"];
